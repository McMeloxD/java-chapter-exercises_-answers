...
public class KtvSong2 {
    ...
    // 添加歌曲方法
    public static void addSong(String name, LinkedList<String> songs) {
    ...
    // 置顶
    public static void topSong(String name, LinkedList<String> songs) {
        // 先判断要置顶的歌曲有没有
        if (!songs.contains(name)) {
    ...
    // 将歌曲前移一位
    public static void lastSong(String name, LinkedList<String> songs) {
        // 先判断要前移的歌曲有没有
        if (!songs.contains(name)) {
